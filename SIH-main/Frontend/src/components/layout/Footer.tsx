        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/about" className="hover:text-purple-200 transition">About Us</Link></li>
              <li><Link to="/student/resources" className="hover:text-purple-200 transition">Resources</Link></li>
              <li><Link to="/community" className="hover:text-purple-200 transition">Community</Link></li>
              <li><Link to="/support" className="hover:text-purple-200 transition">Support</Link></li>
              <li><Link to="/services" className="hover:text-purple-200 transition">Services</Link></li>
            </ul>
          </div>
