...
const AdminHeader: React.FC = () => (
    <header className="bg-white/80 backdrop-blur-md sticky top-0 z-10 border-b">
        <nav className="container mx-auto px-8 py-4 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8 text-text-medium font-medium">
                <Link to="/admin/dashboard" className="text-primary">Dashboard</Link>
                <Link to="/admin/users" className="hover:text-primary">Users</Link>
                <a href="#" className="hover:text-primary">Sessions</a>
                <a href="#" className="hover:text-primary">Resources</a>
                <a href="#" className="hover:text-primary">Support</a>
            </div>
            <div className="flex items-center space-x-4">
                <BellIcon className="h-6 w-6 text-gray-500 hover:text-text-dark" />
                <img src="https://picsum.photos/seed/admin/40/40" alt="Admin Avatar" className="h-9 w-9 rounded-full" />
            </div>
        </nav>
    </header>
);
